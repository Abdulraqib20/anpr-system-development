...
param(
    [string]$RepoName,
    [string]$Description = "ANPR System Final-Year Project Development"
)
...
# 4. Set remote URL 
# git remote add origin https://github.com/Abdulraqib20/anpr-system-development.git

# 5. Run the below in PowerShell:
# ./deploy.ps1 -RepoName "your-repo-name" -Description "Project purpose"

# ./deploy.ps1 -RepoName "anpr-system-development" -Description "ANPR System Final-Year Project Development"
